...
class ROSLinkBridgeTurtlebot:
    ...
    def init_params():   
        ...
        # get map location
        ROSLinkStateVariables.map_location = rospy.get_param("/map_location", "non")
    ...
    def start_ros_subscribers():
        ...
        rospy.Subscriber("/amcl_pose", PoseWithCovarianceStamped, ROSLinkBridgeTurtlebot.amclCallback)
    ...
    def create_roslink_message_threads(): 
        ...
        ROSLinkBridgeTurtlebot.ROSLinkImage_message_thread = ROSLinkMessageThread(ROSLinkBridgeTurtlebot.client_socket,  ROSLinkBridgeTurtlebot.server_address, MESSAGE_TYPE.ROSLINK_MESSAGE_ROSLINK_IMAGE, "ROSLink_image_thread", ROSLinkBridgeTurtlebot.ROSLing_Image_msg_rate)
