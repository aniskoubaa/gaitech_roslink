...
class ROSLinkBridgeTurtlebot:
    ...
    def init_servers():
        ...
        ROSLinkBridgeTurtlebot.WSconnected=False
        ROSLinkBridgeTurtlebot.ws = None;

        
        t = threading.Thread(target=ROSLinkBridgeTurtlebot.websocketThread)
    ...
    @staticmethod
    def websocketThread():
    	if(not ROSLinkBridgeTurtlebot.WSconnected):
    		WS_url = "ws://"+ ROSLinkBridgeTurtlebot.gcs_server_ip+":9090/websockets/roslink/user/"+str(ROSLinkStateVariables.owner_id) +"/robot/"+ROSLinkStateVariables.key+"/robot" 
    		ROSLinkBridgeTurtlebot.ws = websocket.WebSocketApp(WS_url,
                                on_message = ROSLinkBridgeTurtlebot.on_message,
                                on_error = ROSLinkBridgeTurtlebot.on_error,
                                on_close = ROSLinkBridgeTurtlebot.on_close)
        	ROSLinkBridgeTurtlebot.ws.on_open = ROSLinkBridgeTurtlebot.on_open
    		
        	# ROSLinkBridgeTurtlebot.WSconnected=True;
	        ROSLinkBridgeTurtlebot.ws.run_forever()
    ...
    def on_close(ws):   
		...
		ROSLinkBridgeTurtlebot.handel_websocket_closing();
    ...
    def on_message(ws, message):
        ROSLinkBridgeTurtlebot.process_roslink_command_message(message)
    ...
    def init_params():   
        ...
        # get robot name
        ROSLinkStateVariables.robot_name = rospy.get_param("/robot_name", "TURTLEBOT_BURGER")
        # get robot type
        ...
        ROSLinkBridgeTurtlebot.heartbeat_msg_rate = rospy.get_param("/heartbeat_msg_rate", ROSLINK_MESSAGE_PERIOD.ROSLINK_HEARTBEAT_MESSAGE_RATE)
        ROSLinkBridgeTurtlebot.robot_status_msg_rate = rospy.get_param("/robot_status_msg_rate", ROSLINK_MESSAGE_PERIOD.ROSLINK_ROBOT_STATUS_MESSAGE_RATE)
        ROSLinkBridgeTurtlebot.global_motion_msg_rate = rospy.get_param("/global_motion_msg_rate", ROSLINK_MESSAGE_PERIOD.ROSLINK_GLOBAL_MOTION_MESSAGE_RATE)
        ROSLinkBridgeTurtlebot.gps_raw_info_msg_rate = rospy.get_param("/gps_raw_info_msg_rate", ROSLINK_MESSAGE_PERIOD.ROSLINK_GPS_RAW_INFO_MESSAGE_RATE)
        ROSLinkBridgeTurtlebot.range_finder_data_msg_rate = rospy.get_param("/range_finder_data_msg_rate", ROSLINK_MESSAGE_PERIOD.ROSLINK_RANGE_FINDER_DATA_MESSAGE_RATE)
        ROSLinkBridgeTurtlebot.ROSLing_Image_msg_rate = rospy.get_param("/ROSLing_Image_msg_rate", 1)

        ROSLinkBridgeTurtlebot.bridge = CvBridge()
    ...
    def start_ros_publishers():
        ...
        ROSLinkBridgeTurtlebot.move_publisher = rospy.Publisher('/cmd_vel',Twist, queue_size=10)    

    #start ROS subscribers
    @staticmethod
    def start_ros_subscribers():
        rospy.Subscriber("/odom", Odometry, ROSLinkBridgeTurtlebot.odometryCallback)
        # rospy.Subscriber("/usb_cam/image_raw/compressed", CompressedImage, ROSLinkBridgeTurtlebot.compressedImageCallback)
        rospy.Subscriber("/camera/rgb/image_raw/compressed", CompressedImage, ROSLinkBridgeTurtlebot.compressedImageCallback)
    ...
    def odometryCallback(msg):
        ...
        #twist: angular
        ROSLinkBridgeTurtlebot.wx = msg.twist.twist.angular.x
    ...
    def create_roslink_message_threads(): 
        ROSLinkBridgeTurtlebot.heatrbeat_message_thread = ROSLinkMessageThread(ROSLinkBridgeTurtlebot.client_socket, ROSLinkBridgeTurtlebot.ws, ROSLinkBridgeTurtlebot.server_address, MESSAGE_TYPE.ROSLINK_MESSAGE_HEARTBEAT, "heatrbeat_message_thread", ROSLinkBridgeTurtlebot.heartbeat_msg_rate)
        ROSLinkBridgeTurtlebot.robot_status_thread = ROSLinkMessageThread(ROSLinkBridgeTurtlebot.client_socket, ROSLinkBridgeTurtlebot.ws, ROSLinkBridgeTurtlebot.server_address, MESSAGE_TYPE.ROSLINK_MESSAGE_ROBOT_STATUS, "robot_status_thread", ROSLinkBridgeTurtlebot.robot_status_msg_rate)
        ROSLinkBridgeTurtlebot.global_motion_thread = ROSLinkMessageThread(ROSLinkBridgeTurtlebot.client_socket, ROSLinkBridgeTurtlebot.ws, ROSLinkBridgeTurtlebot.server_address, MESSAGE_TYPE.ROSLINK_MESSAGE_GLOBAL_MOTION, "global_motion_thread", ROSLinkBridgeTurtlebot.global_motion_msg_rate)
        ROSLinkBridgeTurtlebot.ROSLinkImage_message_thread = ROSLinkMessageThread(ROSLinkBridgeTurtlebot.client_socket, ROSLinkBridgeTurtlebot.ws,  ROSLinkBridgeTurtlebot.server_address, MESSAGE_TYPE.ROSLINK_MESSAGE_ROSLINK_IMAGE, "ROSLink_image_thread", ROSLinkBridgeTurtlebot.ROSLing_Image_msg_rate)
...
# ROSLinkBridgeTurtlebot.gps_raw_info_thread = ROSLinkMessageThread(ROSLinkBridgeTurtlebot.client_socket,  ROSLinkBridgeTurtlebot.server_address, MESSAGE_TYPE.ROSLINK_MESSAGE_GPS_RAW_INFO, "gps_raw_info_thread", ROSLinkBridgeTurtlebot.gps_raw_info_msg_rate)
    ...
    def static_build_ROSLink_image_message():
        message_header = ROSLinkBridgeTurtlebot.static_build_roslink_header_message(MESSAGE_TYPE.ROSLINK_MESSAGE_ROSLINK_IMAGE) 
    ...
    def process_roslink_command_message(msg):
        ...
        if command['header']['message_id'] == MESSAGE_TYPE.ROSLINK_MESSAGE_COMMAND_TWIST:  
            ...
            try:
                ...
                message_header = ROSLinkBridgeTurtlebot.static_build_roslink_header_message(MESSAGE_TYPE.ROSLINK_MESSAGE_ROSLINK_MAP)
                ...
                ROSLinkBridgeTurtlebot.client_socket.sendto(roslinkmap,ROSLinkBridgeTurtlebot.server_address)
                return;
            except:
                pass
...
class ROSLinkMessageThread ():
    count = 0
    def __init__(self,  sock, WS,server_address,message_type ,thread_name='noname', data_rate=30.0):
        ...
        while True:
            ...
            if (self.roslink_message_type == MESSAGE_TYPE.ROSLINK_MESSAGE_HEARTBEAT):
                if (ROSLinkStateVariables.WSconnected):
                	...
                	self.WS.send(json.dumps(ROSLinkBridgeTurtlebot.static_build_heartbeat_message()))
                else:
                	self.send(self.socket, json.dumps(ROSLinkBridgeTurtlebot.static_build_heartbeat_message()))
                	self.WS = ROSLinkBridgeTurtlebot.ws;
                ...
                if (ROSLinkStateVariables.WSconnected):
                	...
                	json.dumps(ROSLinkBridgeTurtlebot.static_build_gps_raw_info_message())
                	self.WS = ROSLinkBridgeTurtlebot.ws;
                ...
                if (ROSLinkStateVariables.WSconnected):
                	self.WS.send(json.dumps(ROSLinkBridgeTurtlebot.static_build_ROSLink_image_message()))
                else:
                	json.dumps(ROSLinkBridgeTurtlebot.static_build_gps_raw_info_message())
                	self.WS = ROSLinkBridgeTurtlebot.ws;
                ...
                if (ROSLinkStateVariables.WSconnected):
                	...
                	# self.send(self.socket, json.dumps(ROSLinkBridgeTurtlebot.static_build_ROSLink_image_message()))
