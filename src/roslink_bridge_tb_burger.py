...
class ROSLinkBridgeTurtlebot:
    ...
    def compressedImageCallback(data):
        # if(ROSLinkStateVariables.ROSLinkImageUpdatingCounter>ROSLinkStateVariables.ROSLinkImageSendingCounter):
        # 	return;
        ...
        data1 =  u''+base64.encodestring(np_arr)
        # print(len(data))
        if(len(data1)<64000):
            ROSLinkStateVariables.ROSLinkImageData=data1[:1245]
        else:
            ROSLinkStateVariables.ROSLinkImageData=data1[64000:]
        
        # ROSLinkStateVariables.ROSLinkImageData =data #[:8000];
        # ROSLinkStateVariables.ROSLinkImageUpdatingCounter+=1;
        print(len(data1))
...
class ROSLinkMessageThread ():
    count = 0
    def __init__(self, sock, server_address,message_type ,thread_name='noname', data_rate=5.0):
